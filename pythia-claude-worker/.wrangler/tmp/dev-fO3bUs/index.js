...
// .wrangler/tmp/bundle-UrhuSb/checked-fetch.js
...
// .wrangler/tmp/bundle-UrhuSb/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-UrhuSb/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
// src/alcs-intent-classifier.ts
init_checked_fetch();
init_modules_watch_stub();
var ALCS_SYSTEM_PROMPT = `You are an ALCS intent classifier.
...
async function classifyALCSIntent(userMessage, anthropicApiKey) {
...
__name(classifyALCSIntent, "classifyALCSIntent");

// src/healthcare-coordinator.ts
init_checked_fetch();
init_modules_watch_stub();
async function handleHealthcareCoordination(request, userLocation) {
...
__name(handleHealthcareCoordination, "handleHealthcareCoordination");

// src/index.ts
async function executeALCSTool(intent, apiKey) {
  switch (intent.toolType) {
    case "healthcare_coordinator":
      return await handleHealthcareCoordination(
        { action: intent.action, details: intent.details },
        { lat: 0, lng: 0 }
      );
    default:
      return null;
...
__name(executeALCSTool, "executeALCSTool");
async function synthesizeVoiceWithElevenLabs(text, voiceId, env) {
